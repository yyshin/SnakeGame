...
class MainViewController: UIViewController, SnakeViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        for direction in [UISwipeGestureRecognizerDirection.Right,
                          ...
                          UISwipeGestureRecognizerDirection.Down] {
                            let gr = UISwipeGestureRecognizer(target: self, action: #selector(MainViewController.swipe(_:)))
    ...
    func startGame() {
        ...
        self.makeNewFruit()
        self.timer = NSTimer.scheduledTimerWithTimeInterval(0.1, target: self, selector: #selector(MainViewController.timerMethod(_:)), userInfo: nil, repeats: true)
